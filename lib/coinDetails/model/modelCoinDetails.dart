...
ModelCoinDetails modelCoinDetailsFromJson(String str) => ModelCoinDetails.fromJson(json.decode(str));

String modelCoinDetailsToJson(ModelCoinDetails data) => json.encode(data.toJson());

class ModelCoinDetails {
  ModelCoinDetails({
    this.id,
    this.symbol,
    this.name,
  ...
  dynamic genesisDate;
  int sentimentVotesUpPercentage;
  int sentimentVotesDownPercentage;
  int marketCapRank;
  int coingeckoRank;
  ...
  factory ModelCoinDetails.fromJson(Map<String, dynamic> json) => ModelCoinDetails(
    id: json["id"],
    symbol: json["symbol"],
    name: json["name"],
